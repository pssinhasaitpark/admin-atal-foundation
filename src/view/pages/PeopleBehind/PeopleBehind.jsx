...
const PeopleBehind = () => {
  ...
  const [title, setTitle] = useState("People Behind");
  ...
  // useEffect(() => {
  //   if (peopleData) {
  //     setTitle(peopleData.title || "People Behind");
  //     setDescription(peopleData.description || "");
  //     setSelectedImages(peopleData.images || []);
  //   }
  // }, [peopleData]);
